...
namespace Tridme {
	void Mesh::SetTriangleData(std::vector<vertex>& vertices, std::vector<unsigned int> &indices) {
		std::vector<vertex> _vertices = {
			{ glm::vec3( 0.0, -1.0, 0.0), glm::vec3(0.0, 0.0, 1.0), glm::vec3(1.0, 0.0, 0.0), glm::vec2(0.0, 1.0) },
			{ glm::vec3( 1.0,  1.0, 0.0), glm::vec3(0.0, 0.0, 1.0), glm::vec3(0.0, 1.0, 0.0), glm::vec2(0.0, 0.0) },
			{ glm::vec3(-1.0,  1.0, 0.0), glm::vec3(0.0, 0.0, 1.0), glm::vec3(0.0, 0.0, 1.0), glm::vec2(1.0, 0.0) },
		};
	...
	void Mesh::SetQuadData(std::vector<vertex>& vertices, std::vector<unsigned int> &indices) {
		std::vector<vertex> _vertices = {
	...
	void Mesh::SetCubeData(std::vector<vertex>& vertices, std::vector<unsigned int> &indices) {
		std::vector<vertex> _vertices = {
			//front
			...
			{ glm::vec3(-1.0,  1.0, -1.0), glm::vec3(-1.0f, 0.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0), glm::vec2(0.0, 0.0) }, //9
			...
			{ glm::vec3(1.0,  1.0,  1.0), glm::vec3(1.0f, 0.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0), glm::vec2(0.0, 0.0) }, //13
			...
			//bottom 
			{ glm::vec3(-1.0, -1.0, -1.0), glm::vec3(0.0f, -1.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0), glm::vec2(0.0, 1.0) }, //20
	...
	void Mesh::SetSphereData(std::vector<vertex>& vertices, std::vector<unsigned int> &indices) {
		std::vector<vertex> _vertices;
		std::vector<unsigned int> _indices;
